...
const SidebarLink = ({
    ...
    return (
        <Link href={href}>
            <div className={`flex items-center cursor-pointer ${isCollapsed ? "justify-center py-4" : "justify-start py-4 px-8"
    ...
    return (
        <div className={sidebarClassNames}>
            ...
            <div className={`${isSidebarCollapsed ? "hidden" : "block"} mb-10`}>
                <p className='text-center text-xs text-gray-500'>&copy; 2024, Harsh</p>
            </div>
        </div>
    )
}
